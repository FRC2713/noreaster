      ...
      <div className="group border rounded-lg p-4 text-sm flex flex-col gap-3 bg-card hover:bg-accent/50 transition-all duration-200 hover:shadow-sm cursor-pointer">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className={`flex items-center gap-1 ${timeColor}`}>
            {timeIcon}
            <span className="text-xs font-medium">{timeLabel}</span>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between gap-3">
          {/* Red Alliance */}
          <div className="flex items-center gap-2 p-2 rounded-md bg-red-50/50 dark:bg-red-950/10 flex-1">
            {/* Red Alliance Emblem */}
          ...
          {/* Blue Alliance */}
          <div className="flex items-center gap-2 p-2 rounded-md bg-blue-50/50 dark:bg-blue-950/10 flex-1">
